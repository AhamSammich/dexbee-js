...
describe('Relationships', () => {
  ...
  describe('hasMany Relationships', () => {
    it('should load posts for users', async () => {
      const users = db.table<User>('users')
    ...
    it('should filter related posts', async () => {
      const users = db.table<User>('users')
    ...
    it('should select specific fields from related posts', async () => {
      const users = db.table<User>('users')
    ...
    it('should limit related posts', async () => {
      const users = db.table<User>('users')
  ...
  describe('hasOne Relationships', () => {
    it('should load profile for users', async () => {
      const users = db.table<User>('users')
    ...
    it('should select specific fields from profile', async () => {
      const users = db.table<User>('users')
  ...
  describe('belongsTo Relationships', () => {
    it('should load author for posts', async () => {
      const posts = db.table<Post>('posts')
    ...
    it('should load user for profiles', async () => {
      const profiles = db.table<Profile>('profiles')
  ...
  describe('belongsToMany Relationships', () => {
    it('should load tags for users', async () => {
      const users = db.table<User>('users')
    ...
    it('should load users for tags', async () => {
      const tags = db.table<Tag>('tags')
  ...
  describe('with() alias', () => {
    it('should work as alias for include()', async () => {
      const users = db.table<User>('users')
