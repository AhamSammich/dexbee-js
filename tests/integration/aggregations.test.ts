...
describe('Aggregations', () => {
  ...
  describe('Simple Aggregations', () => {
    it('should calculate count of all employees', async () => {
      const employees = db.table<Employee>('employees')
    ...
    it('should calculate sum of salaries', async () => {
      const employees = db.table<Employee>('employees')
    ...
    it('should calculate maximum salary', async () => {
      const employees = db.table<Employee>('employees')
    ...
    it('should calculate minimum salary', async () => {
      const employees = db.table<Employee>('employees')
    ...
    it('should handle aggregations with no numeric values', async () => {
      const employees = db.table<Employee>('employees')
  ...
  describe('Aggregations with WHERE clauses', () => {
    it('should calculate sum of salaries for Engineering department', async () => {
      const employees = db.table<Employee>('employees')
    ...
    it('should calculate average age for employees over 30', async () => {
      const employees = db.table<Employee>('employees')
    ...
    it('should calculate max score for Sales department', async () => {
      const employees = db.table<Employee>('employees')
  ...
  describe('Group By Aggregations', () => {
    it('should group by department and calculate average salary', async () => {
      const employees = db.table<Employee>('employees')
    ...
    it('should group by department and calculate sum of salaries', async () => {
      const employees = db.table<Employee>('employees')
    ...
    it('should group by department and count employees', async () => {
      const employees = db.table<Employee>('employees')
  ...
  describe('Complex Aggregation Scenarios', () => {
    it('should handle aggregation with field selection', async () => {
      const employees = db.table<Employee>('employees')
    ...
    it('should calculate multiple aggregations sequentially', async () => {
      const employees = db.table<Employee>('employees')
  ...
  describe('Edge Cases', () => {
    it('should handle null and undefined values in aggregation field', async () => {
      const employees = db.table<Employee>('employees')
    ...
    it('should validate required field for aggregation functions', async () => {
      const employees = db.table<Employee>('employees')
